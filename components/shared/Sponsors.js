...
const sponsors = [
  ...
  //{ name: 'cooperathon', url: 'https://cooperathon.ca/?lang=en', imgWidth: 300 },
      ...
      <div className="flex">
        <div className={styles["sponsor-logos"]}>
          {/*{!justImages &&
              ...
              <p>
              A big thank you to our amazing sponsors, without which MAIS Hacks
              would be impossible!
          </p>
            }*/}
          <div className="flex">
            {sponsors.map((sponsor, index) => (
              ...
              >
                <img
                  src={`/images/sponsor-logos/${sponsor.name}.png`}
          ...
          {!justImages && (
            <p>
              ...
              <a href="mailto:mcgillaicontact@gmail.com">Sponsor MAIS Hacks</a>.
            </p>
          )}
        </div>
      </div>
